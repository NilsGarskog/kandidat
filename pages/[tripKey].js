            ...
            <div className='overflow-x-hidden dark:bg-slate-800'>
                ...
                {(page === "calender" && ItCreated === false && openIt === false) &&
                    <div className='flex items-center flex-col p-3'>
                        <div className='flex flex-col items-center w-5/6 sm:w-2/3 select-none cursor-default dark:text-white'>
                ...
                {page === "settings" &&
                    <div className='flex items-center flex-col dark:text-white'>
                        ...
                        <div className='flex flex-col items-center select-none cursor-default w-4/5'>
