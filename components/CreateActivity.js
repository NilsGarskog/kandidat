          ...
          <div className="flex flex-col items-center font-medium text-base text-black rounded-lg w-full">
            ...
            <div className="select-none">
              <div className="flex flex-start text-xl">
                <p className="p-2 pl-4 pt-4 font-light uppercase">
                  Activity Name
                </p>
              </div>
              <div className="search">
                ...
                <input
                  type="text"
                  className="rounded-lg bg-gray-200 pl-4 p-1 ml-3 italic text-slate-500 w-[30ch] items-center "
                ...
                <div className="flex items-center font-light uppercase">
                  <label className="flex items-center ml-4">
                    <input
                      ...
                      label="Short"
                      name="activitlength"
                      className=" checked:bg-black checked:hover:bg-black checked:active:bg-black checked:focus:bg-black focus:bg-black focus:outline-none focus:ring-1 focus:ring-black cursor-pointer"
                      value={checkedActShort}
                      onChange={(e) => {
                        setCheckedActShort(true);
                      }}
                    />
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      label="Long"
                      name="activitlength"
                      className="checked:bg-black checked:hover:bg-black checked:active:bg-black checked:focus:bg-black focus:bg-black focus:outline-none focus:ring-1 focus:ring-black ml-3 cursor-pointer"
                      value={checkedActShort}
                      onChange={(e) => {
                        setCheckedActShort(false);
                      }}
                    />
              ...
              <div>
                <span className="flex items-center p-2 pl-4 pt-4 font-light">
                  <p className="flex flex-start text-xl uppercase ">
                    Add description{" "}
                  </p>
                ...
                <input
                  ...
                  className="flex items-center rounded-lg bg-gray-200 p-1 pl-4 ml-3 italic text-slate-500 w-[30ch] h-[5ch] "
            ...
            <button
              onClick={() => addActivity()}
              id="addButton"
              className="duration-300 hover:bg-gray-100 rounded-lg drop-shadow-md w-[90px] h-[40px] border uppercase text-xl font-semibold mt-2"
            >
              ADD
            </button>
          </div>
