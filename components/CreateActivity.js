...
export default function CreateActivity(props){
    ...
    return(
        < div className="search">
                    <span></span>
                    <input type="text" className='text-black' placeholder="Add activity..." value={activity} onChange={(e) => {setActivity(e.target.value),
            ...
            <select className="w-full p-2.5 text-gray-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-indigo-600" value={activityType} onChange={(e) => {setActivityType(e.target.value), console.log('Dropdown aktivitet', {activityType})}}>
                <option>Activity</option>
                <option>Lunch</option>
                <option>Dinner</option>
            </select>
            <select className="w-full p-2.5 text-gray-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-indigo-600" value={activityLength} onChange={(e) => {setActivityLength(e.target.value), console.log('Dropdown aktivitet', {activityType})}}>
                <option>Short </option>
                <option>Long </option>
