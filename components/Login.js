  ...
  return (
    <div className='flex sm:flex-row flex-col p-10 h-[300vh] '>
      ...
      <div className=' relative z-30'>
        <h1 className='font-bold sm:text-xl sm:w-1/2  break-word text-black '>Welcome to Travel Planner!<br></br> Finding the best way fit all of the activities and places you want to visit has never been easier.<br></br>  To get started, please sign in or register.</h1>
      </div>
      <div className='flex-1 text-xs sm:text-sm relative z-30 flex flex-col bg-black items-center gap-2 sm:gap-4'>
