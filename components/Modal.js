...
export default function Modal(props) {
    ...
    return ReactDom.createPortal(
        <div className='fixed border border-2 border-black left-auto right-0 inset-0 bg-white text-slate-900 text-lg sm:text-xl flex flex-col' style={{ width: '80vw', maxWidth: '500px' }}>
                            ...
                            <div className='select-none'>
                                ...
                                <div className='flex place-content-between'>
                                    ...
                                    <div className='pr-10 flex place-items-end'>
                                        <button onClick={() => {
                                            handleAddProfileInfo(); close(); handleAddProfileImage();
                                            handleDeleteProfileImage()
                                        }} className="duration-300 hover:bg-gray-100 rounded-lg drop-shadow-md w-[90px] h-[40px] border uppercase text-xl font-semibold">Save!</button>
                                    </div>
                                </div>
                            </div>
                        </>
