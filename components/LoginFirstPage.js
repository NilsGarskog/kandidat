          ...
          >
            {(close) => (
              <div className="flex flex-col items-center space-y-4 font-medium text-base rounded-lg w-full">
                ...
                <h1 className="text-3xl pb-10">Sign up</h1>
                <input
                  type="text"
                  value={email}
              ...
              <div className="flex flex-col items-center space-y-4 font-medium text-base rounded-lg w-full">
                <div className="inline-block">
                  ...
                  <input
                    ...
                    className="outline-none  mb-4 duration-300  border-solid  focus:border-cyan-300 text-slate-900 p-2 w-full max-w-[40ch]"
                  ></input>
                  {!passwordShow && (
                    <i
                      onClick={togglePassword}
