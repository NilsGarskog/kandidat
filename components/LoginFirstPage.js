        ...
        <div className="Wrapper bg-white flex flex-col lg:flex-row z-1000 items-center ">
          ...
          <div className="Wrapper bg-white mt-8 sm:mt-0 flex flex-1 space-between flex-row z-999 items-center md:justify-center">
            <Popup
              ...
              trigger={
                <button className="sm:-ml-10 border bg-buttonGreen text-black text-2xl sm:text-2xl font-bold sm:font-medium uppercase  sm:mr-6 sm:hover:opacity-70 duration-300 mr-10 py-4 px-6 sm:ml-[30%] gap-2 rounded-full shadow-md hover:shadow-lg">
                  Register
                </button>
              }
              onOpen={() => {
            ...
            <Popup
              ...
              trigger={
                <button className="border bg-buttonGreen text-black mr-[20%]  md:mr-[20vh] sm:text-2xl font-bold sm:font-medium uppercase  py-4 px-6 rounded-full duration-300 sm:hover:opacity-70 shadow-md hover:shadow-lg mr-[5%]">
                  Login
                </button>
              }
              onOpen={() => {
